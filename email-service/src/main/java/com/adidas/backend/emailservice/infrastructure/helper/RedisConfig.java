package com.adidas.backend.emailservice.infrastructure.helper;
...
public class RedisConfig {
    ...
    public RedisTemplate<String, AdiClubMember> redisTemplate() {
        ...
        Jackson2JsonRedisSerializer<AdiClubMember> serializer = new Jackson2JsonRedisSerializer<>(AdiClubMember.class);
